...
must be posted to the [Open Conference
Systems](http://events.open-bio.org/BOSC2008/openconf.php)site.
...
-   In the spirit of open source and open access, the organizing
    committee would like to post your slides after your presentation
    at BOSC.
-   We will be using SlideShare, see [ last year's
    BOSC](BOSC_2007_Schedule "wikilink") for an example.
-   Presenters, please e-mail your slides to the organizers at
    [bosc@open-bio.org](mailto:bosc%40open-bio%2eorg), if you have not
    done so already.
