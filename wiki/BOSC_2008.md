...
**May 11: Abstract submission deadline.** All abstracts must be
submitted through our [Open Conference
...
facilitate software re-use (mashups, and traditional), interoperability
and inter-process communication, system/service discovery, and data
movement and modeling in distributed systems. This may include
peer-to-peer systems of data transfer, WebServices and various flavors
of data representation (SOAP, JSON, XML, others), and technologies
commonly referred to under the Web 2.0 paradigm (e.g.
