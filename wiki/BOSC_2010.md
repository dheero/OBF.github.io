...
-   **The Semantic Web in open source bioinformatics** -- Emerging
    ...
    resources and tools for bioinformatics. We solicit
...
-   Manuscripts will be due after the conference on August 15, 2010 to
    ...
    Solution Challenge).
-   Manuscripts for all [BOSC 2010\#Session
    Topics](BOSC_2010#Session_Topics "wikilink") will be considered.
-   Manuscripts will be peer-reviewed (abstract acceptance to BOSC does
    not guarantee publication in the Proceedings).
-   Manuscripts must conform to BMC Bioinformatics
    [Media:Instructions\_for\_authors\_-\_BMC\_-\_Appendix\_A.pdf author
    guidelines and
    formatting](Media:Instructions_for_authors_-_BMC_-_Appendix_A.pdf_author_guidelines_and_formatting "wikilink"),
