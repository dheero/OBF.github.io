...
-   **Data & Analysis Management** (shared session with DAM SIG) (topic
    organizer: [Anton Nekrutenko](http://www.bx.psu.edu/~anton/))
-   **Computational Grids** (topic organizers: Steffen Moeller, [Frank
    Drews](http://frankdrews.com/))
    -   Presentation of projects in computational biology that adapted
        ...
        been achieved alone.
-   **Visualization** (topic organizers: Jim Procter, [Seán
