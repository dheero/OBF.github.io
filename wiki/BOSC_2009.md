...
-   **Design Patterns in Bioinformatics** (topic organizer: [Lonnie
    ...
    -   Various recurring patterns have emerged in the field
        ...
        of these patterns, and this session will feature presntations
        that analyze and codify the bioinformatics patterns. See
...
-   **Computational Grids** (topic organizers: [Steffen
    Moeller](http://www.inb.uni-luebeck.de/~moeller/), [Frank
    Drews](http://frankdrews.com/))
    -   Presentation of projects in computational biology that adapted
        grid technologies for the research or services. How
        heterogeneous resources from multiple geographical locations
        were brought together to achieve what could barely could have
        been achieved alone.
...
-   Jens Lichtenberg (Ohio University)
    -   Publications (responsible for managing the EasyChair site and
        making the abstract program)
