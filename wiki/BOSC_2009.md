...
Abstract acceptances have gone out. We will be posting the schedule and
abstracts [ here](BOSC_2009_Schedule "wikilink") as soon as we receive
confirmation from each of the speakers. Currently on that page there is
a partial list of confirmed speakers; we will add to it as we hear back
from them.
