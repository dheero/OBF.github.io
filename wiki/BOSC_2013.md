...
-   Genome-scale Data Management -- This session will focus on processes
    ...
    'omic data.
-   Visualization -- The main goal of data visualization is to
    communicate information clearly and effectively through
    graphical means. This session explores approaches to presenting
    large biomedical datasets with visual aids that make the data easier
