...
Abstract submission for talks is now closed. However, we are accepting
poster abstracts in May.

Important Dates
---------------

-   April 4, 2014: Deadline for submitting talk abstracts
-   June 5, 2014: Deadline for [submitting poster and lightning talk
    abstracts](http://events.open-bio.org/BOSC2014/openconf.php) (though
    there will also be some last-minute poster spots)
