...
-   Call for abstracts opens: March 3, 2015
...
-   **Standards Interoperability** -- includes standards such as
    ...
    better together.
-   **Data Science** -- encompasses software and other tools designed
    for managing, exploring, and analyzing large-scale data to address
    research questions, such as genome assembly, variant prediction,
