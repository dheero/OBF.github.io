...
The deadline for submitting talk abstracts has passed. However, you can
still [submit a poster
abstract](http://events.open-bio.org/BOSC2011/author/submit.php). Poster
abstracts must be received by June 15 in order to appear in the BOSC
program. If you miss that deadline, there may still be last-minute
