...
The complete proceedings are now available. This large (6 Mb) PDF file
includes the schedule and all of the talk and poster abstracts. This
year, only the schedule will be printed and given to conference
attendees, so if you want to print the Proceedings, you should do so at
home before you head to BOSC. ISMB does not make it possible to print
