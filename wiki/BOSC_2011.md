...
-   June 3, 2011: Early registration deadline for SIGs (including BOSC).
    Register via the \[ISMB website
    <http://www.iscb.org/ismbeccb2011-registration#1daysig>\]. You can
    register for BOSC (a two-day SIG) without registering for ISMB, if
    you wish.
