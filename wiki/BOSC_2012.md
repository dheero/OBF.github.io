...
the world so they can increase the visibility of their work, forge
connections with other developers, and work together to build shared
resources. For those who are bioinformatics software users rather than
developers, BOSC helps expose them to the wide array of projects that
they might find useful (and perhaps they will be inspired to begin
contributing to some of these projects). BOSC is not just a conference
for presentations of completed work, but is a dynamic meeting where
collaborative work gets done and attendees can learn about new or
ongoing developments that they can directly apply to their own work.
