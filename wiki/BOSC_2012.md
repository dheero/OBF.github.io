...
-   June 1, 2012: Last day for early registration discount (registration
    ...
    for BOSC)
-   June 4, 2012: Deadline for authors to submit updated abstracts, and
    for submission of poster abstracts if you want them to be included
    in the BOSC program. (There will also be room at BOSC for
    last-minute posters.)
