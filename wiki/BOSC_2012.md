...
Carole's keynote talk title is "If I build it will they come?":
\[i\]Over the years I have built a bunch of open source software and
services for reseachers: the Taverna workflow system, myExperiment for
workflow sharing, BioCatalogue for services, SEEK for Systems Biology
data and models, and most recently MethodBox for longtitudinal data
sets. As well as building software we built communities: development
